...
const PlayerUi = () => {
    ...
    const {cameraRig, camera, selectedPinpoint, selectedMap, isEditorMode,} = useContext(VrViewerDepthContext)
    ...
    const [fov, setFov] = useState((camera as any).fov)
