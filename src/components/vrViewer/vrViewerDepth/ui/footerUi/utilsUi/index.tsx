...
const UtilsUi = () => {
    ...
    const {isEditorMode, isFullscreen, setIsFullscreen} = useContext(VrViewerDepthContext)
    ...
    return (  
        ...
        >
            ...
            >
                ...
                :null}
                <ScreenshootUi/>
                {selectedProject.globalSettings.music.url !== '' && selectedProject.globalSettings.music.enable?
                    <AmbientSound/>
                :null}
                {!isFullscreen?
                    <FullscreenUi/>
